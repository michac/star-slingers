...
- **Implementation note:** hand-rolled (`public/sw.js` + `public/manifest.webmanifest`),
  ...
  have. All PWA URLs are relative so they resolve under the `…/mike-star-slingers/`
